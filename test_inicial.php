...
<style>
    ...
    /*Pequenia*/
    @media (min-width: 0px) { 
                .respuestas{color: #a9a8a8 ; margin-left:4px; }
                .formulario{display:none;}
                .formulario_rectangular{height:100%; width:100%; z-index:0; display:none;}
    ...
    @media (min-width: 768px) {
        ...
        .formulario{height:720px; width:750px; display:none}/*--OCULATDO DORMULARIO*/
        .encabezado1, .encabezado2, .encabezado3,.encabezado4, .encabezado5, .encabezado6, .encabezado7, .encabezado8,.encabezado9, .encabezado10  {
            font-size:0.9em;
            width: 600px;
        }
    ...
    @media (min-width: 992px) { 
        .pie{font-size:0.8em;}
        .formulario{height:800px;width:790px;}
    ...
    @media (min-width: 1200px) { 
        .formulario{ height:100%;  max-height:800px; min-height:700px; width:900px;}
    }

    /*XXL XX-Large devices (larger desktops, 1400px and up)*/
    @media (min-width: 1400px) { 
        .formulario{ height:100%; max-height:1000px; min-height:950px;  max-width:1000px; }
        .encabezado1, .encabezado2, .encabezado3,.encabezado4, .encabezado5, .encabezado6, .encabezado7, .encabezado8,.encabezado9, .encabezado10  {
 ...
 <div class="d-none d-xxl-block bg-primary fw-bolder text-center ">ESTAS EN XXL</div>-->
			...
			<div class="row " style="min-height: 80vh;">
                <div class="h-90 col-12 col-xl-9 col-xxl-8 flex-column  align-items-center align-items-xxl-end d-flex align-content-center justify-content-center  text-center  mt-5 mt-lg-1 mt-5 mt-xl-0">
                    ...
                    <img class="formulario_rectangular position-absolute d-md-none" src="Imagenes/formulario_rectangular.png" alt="">
                </div>
              

                <div class="col-12 col-xl-3 col-xxl-4 my-auto d-flex justify-content-center justify-content-xxl-start ">
                     <h1 class="titulos animate__animated animate__pulse text-center text-xxl-start ms-xxl-0 text-light mt-5 mt-lg-0">TEST INICIAL</h1>
                </div> 
            </div>  
