...
if ($_SESSION["usuario"] && $_SESSION["tipo"]=="Usuario"){
    ...
    while($datos = $query->fetch_array()){
        //$respuesta="llegue a ciclo".$accion;
                        if($datos['TestFinal']=="" && $datos['RespuestasTF']==""){
                          if($accion=="guardar"){
                                   ...
                                   $calificacion=0;
                                    ...
                                    if($respueta2=="1"){$calificacion++;$R2=1;}else{$R2=0;}
                                    if($respueta3=="1"){$calificacion++;$R3=1;}else{$R3=0;}
                                    if($respueta4=="1"){$calificacion++;$R4=1;}else{$R4=0;}
                                    if($respueta5=="2"){$calificacion++;$R5=1;}else{$R5=0;}
                                    if($respueta6=="1"){$calificacion++;$R6=1;}else{$R6=0;}
                                    if($respueta7=="1"){$calificacion++;$R7=1;}else{$R7=0;}
                                    if($respueta8=="2"){$calificacion++;$R8=1;}else{$R8=0;}
                                    ...
                                    $actualizar = "UPDATE Test SET  TestFinal='$calificacion', RespuestasTF='$cadenaRespuestas' WHERE Usuario = '$usuariotest'";
                         ...
                         if($accion == "verificar"){
                            ...
                            if($accion=="verificar"){
                                        ...
                                        $respuesta[1] = $datos['TestFinal'];
                                        $separandoRespuetas= explode(" ",$datos['RespuestasTF']);  
                                        if($separandoRespuetas[0]=="1"){ $respuesta[2]="1";}else{$respuesta[2]="2";}
                                        if($separandoRespuetas[1]=="1"){ $respuesta[3]="1";}else{$respuesta[3]="2";}
                                        if($separandoRespuetas[2]=="1"){ $respuesta[4]="1";}else{$respuesta[4]="2";}
                                        if($separandoRespuetas[3]=="1"){ $respuesta[5]="1";}else{$respuesta[5]="2";}
                                        if($separandoRespuetas[4]=="1"){ $respuesta[6]="2";}else{$respuesta[6]="1";}
                                        if($separandoRespuetas[5]=="1"){ $respuesta[7]="1";}else{$respuesta[7]="1";}
                                        if($separandoRespuetas[6]=="1"){ $respuesta[8]="1";}else{$respuesta[8]="2";}
                                        if($separandoRespuetas[7]=="1"){ $respuesta[9]="2";}else{$respuesta[9]="1";}
