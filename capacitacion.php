...
/*Pequenia*/
@media (min-width: 0px) { 
    .texto_indicaciones{color:#76e6b9;}
    .formulario{height:600px}
    .marcovideo{height:230px;}
    .icono_play{height:120px; position:absolute; margin-top:50px; margin-left: 80px;}
...
@media (min-width: 576px) { 
    ...
    .icono_play{height:100px; position:absolute; margin-top:30px; margin-left: 50px;}
...
@media (min-width: 1400px) { 
    ...
    .icono_play{height:120px; position:absolute; margin-top:40px; margin-left: 70px;}
 ...
 <div class="d-none d-xxl-block bg-primary fw-bolder text-center ">ESTAS EN XXL</div>-->
			...
			<div class="row" style="height: 10vh;">
                ...
                <div class="d-flex justify-content-center col-12">
                     <h1 class="titulos animate__animated animate__pulse text-light">CAPACITACIÓN</h1>
                </div>
			</div>

 
			<div  class="contenido row d-flex mt-5">
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3 text-center"><img class="icono_play" src="Imagenes/icono_reproducir.png" alt=""> <img class="marcovideo" src="Imagenes/marcovideos.png" alt=""> </div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3 text-center"><img class="icono_play" src="Imagenes/icono_reproducir.png" alt=""> <img class="marcovideo" src="Imagenes/marcovideos.png" alt=""></div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3 text-center"><img class="icono_play" src="Imagenes/icono_reproducir.png" alt=""><img class="marcovideo" src="Imagenes/marcovideos.png" alt=""></div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3 text-center"><img class="icono_play" src="Imagenes/icono_reproducir.png" alt=""><img class="marcovideo" src="Imagenes/marcovideos.png" alt=""></div>
                <div class="col-12 col-sm-6 col-md-4 col-xxl-3 text-center"><img class="icono_play" src="Imagenes/icono_reproducir.png" alt=""><img class="marcovideo" src="Imagenes/marcovideos.png" alt=""></div>
